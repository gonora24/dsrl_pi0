...
class PixelSACLearner(Agent):
    ...
    def __init__(self,
        ...
        if use_transformer_actor:
            ...
            policy_def = AutoregressiveActorTransformer(
                ...
                residual_log_std_high=residual_log_std_high,
                residual_log_std_low=residual_log_std_low,
            )
    ...
    def restore_from_checkpoint_dir(cls, ckpt_dir: str, seed: int = 0, extra_args: Dict[str, Any] = {}) -> 'PixelSACLearner':
        ...
        agent = cls(
            ...
            residual_log_std_high=cfg.get('residual_log_std_high', -1.5),
            residual_log_std_low=cfg.get('residual_log_std_low', -20.0),
