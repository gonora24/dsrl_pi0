...
if __name__ == '__main__':
    ...
    parser.add_argument('--residual_mean_bound', default=0.2, help='bound (clip) for the AR actor mean residual head (diff_mean)', type=float)
    parser.add_argument('--residual_log_std_high', default=0.2, help='upper clip bound for the AR actor log-std residual head', type=float)
    parser.add_argument('--residual_log_std_low', default=-0.2, help='lower clip bound for the AR actor log-std residual head', type=float)
    ...
    parser.add_argument('--use_actor_diff_mean', default=0, help='use autoregressive mean predictor', type=int)
    ...
    parser.add_argument('--freeze_latent_models', default=0, type=int,
                        help='freeze latent models for first N steps')
    ...
    parser.add_argument('--noise_mapping_distill_path', default=None, help='path to noise mapping distillation file', type=str)
