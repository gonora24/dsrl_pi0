...
if __name__ == '__main__':
    ...
    parser.add_argument('--residual_mean_bound', default=0.3, help='bound (clip) for the AR actor mean residual head (diff_mean)', type=float)
    parser.add_argument('--residual_log_std_bound', default=2.0, help='bound (clip) for the AR actor log-std residual head', type=float)
