...
#SBATCH --nodes=1
#SBATCH --gres=gpu:1 
#SBATCH --job-name=dsrl_na_mlp_task59
...
--algorithm dsrl_na \
--trajectory_hdf5_path /pfs/work9/workspace/scratch/ka_eu3660-rlinf_tmp/DSRL_NA_trajectories/pi05_libero90_task59/trajectories_task59_7000_combined.hdf5 \
--env libero \
--prefix dsrl_na_libero_90_task59 \
--suffix singleactorcritic_offline_mlp_10qs_7dims \
...
--use_mlp_action_space_critic 1 \
--use_noise_mapping_distill 1 \
--noise_mapping_distill_path /pfs/work9/workspace/scratch/ka_eu3660-rlinf_tmp/DSRL_NA_noise_action_mapping/noise_action_mapping_task59_repeat.h5 \
...
#--restore_path /pfs/work9/workspace/scratch/ka_eu3660-rlinf_tmp/DSRL_NA_Libero/dsrl_na_libero_90_task59_2026_08_15_02_39_46_0000--s-0_singleactorcritic_offline/checkpoint65000 \