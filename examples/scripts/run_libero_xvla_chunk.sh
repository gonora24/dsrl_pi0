...
#SBATCH --nodes=1
#SBATCH --gres=gpu:1 
#SBATCH --job-name=dsrl_xvla_libero_90_task32_chunkrewardcriticactor_mlp
...
export OUTPUT_DIR=/pfs/work9/workspace/scratch/ka_eu3660-rlinf_tmp/DSRL_xvla_Libero
...
--algorithm pixel_sac \
--env libero \
--prefix dsrl_xvla_libero_90_task32 \
