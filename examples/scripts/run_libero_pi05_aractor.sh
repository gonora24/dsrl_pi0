...
#SBATCH --nodes=1
#SBATCH --gres=gpu:1 
#SBATCH --job-name=dsrl_pi05_libero_90_task28_aractor_marginalizelp
...
--suffix chunkrewardcriticactor_aractor_10replan_marginalizelp \
