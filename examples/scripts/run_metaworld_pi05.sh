...
#SBATCH --nodes=1
#SBATCH --gres=gpu:1 
#SBATCH --job-name=dsrl_pi05_metaworld_task1_baseline

module load devel/miniforge
conda deactivate
conda activate dsrl_pi0_meta
...
proj_name=DSRL_pi05_Metaworld
device_id=0
wandb_mode=offline  # online or offline
export WANDB_MODE=${wandb_mode}

export PYTHONPATH="${PYTHONPATH}:/pfs/data6/home/ka/ka_anthropomatik/ka_eu3660/projects/dsrl_pi0_meta/"
...
--algorithm pixel_sac \
--env metaworld \
--prefix dsrl_pi05_metaworld_task1 \
--suffix baseline \
...
--query_freq 5 \
--hidden_dims 128 \
--metaworld_task_name basketball-v3 \
--pi0_checkpoint rlinf_hf_pi05_metaworld \
--chunk_reward 0 \
